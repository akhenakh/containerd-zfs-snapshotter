...
func newTestZpool() (string, func() error, error) {
	...
	zpool, err := zfs.PoolCreate(zpoolName, nil, lo.File)
	if err != nil {
		return "", nil, err
	}
...
func newSnapshotter() func(context.Context, string) (snapshots.Snapshotter, func() error, error) {
	return func(ctx context.Context, root string) (snapshots.Snapshotter, func() error, error) {
		...
		testZFS, err := zfs.DatasetCreate(testZFSName, zfs.DatasetTypeFilesystem, map[zfs.Prop]zfs.Property{
			zfs.DatasetPropMountpoint: zfs.Property{Value: testZFSMountpoint},
		})
		if err != nil {
		...
		return snapshotter, func() error {
			...
			if err := testZFS.DestroyRecursive(); err != nil {
				return err
			}
